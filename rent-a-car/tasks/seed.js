...
async function main(){
    ...
    await data.cars.createCar("2018 Honda Civic", "Sedan", "black", "4", "5", "30$/hr", true, "gas")
    await data.cars.createCar("2020 Audi A6", "Sedan", "GREY", "4", "5", "60$/hr", true, "gas")
    await data.cars.createCar("2019 Nissan Altima", "Coupe", "blue", "2", "4", "40$/hr", true, "gas")
    await data.cars.createCar("2021 Tesla Model S", "Sedan", "red", "4", "5", "70$/hr", true, "electric")
